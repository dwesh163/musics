  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="bg-gradient-to-br from-purple-900/90 to-gray-900 p-6 rounded-xl">
        ...
        <Image
          src="https://images.unsplash.com/photo-1571330735066-03aaa9429d89?w=500&h=500&q=80"
          alt="Playlist Cover"
          width={200}
          height={200}
      ...
      <div className="bg-gradient-to-br from-blue-900/90 to-gray-900 p-6 rounded-xl relative overflow-hidden">
        <Image
          src="https://images.unsplash.com/photo-1516280440614-37939bbacd81?w=1000&h=600&q=80"
          alt="Featured Track"
          layout="fill"
          objectFit="cover"
